    ...
    <section class="bg-dark  py-5">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <a class="text-light fs-2 text-decoration-none " href="#">facebook</a>
            <a class="text-light fs-2 text-decoration-none ms-2 me-2" href="#">instagram</a>
            <a class="text-light fs-2 text-decoration-none" href="#">twitter</a>
          </div>
          <div class="col-md-4 ">
